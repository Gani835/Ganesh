...
#41) To find Even Numbers in a given range:-
...
#42) To find the Quotient and Remainder of numbers:-
...
#43) To find the smallest divisor of a number:-
...
#44) To find the sum of N natural numbers:-(1+2+3+4+ -------- +n model)
...
num=int(input("Enter a number:"))                         #  1=1
for j in range(1,num+1):                                          # 1+2=3
    a=[]                                                                      #1+2+3=6
    for i in range(1,j+1):                                              #1+2+3+4=10 like this model.
        print(i,sep=' ' ,end=' ')
        if i<j:
            print('+',sep=' ',end=' ')
        a.append(i)
...
#45) To find the largest number in a list:-
...
for i in range(0,num):
    ...
    a.append(elem)
a.sort()
print(a[num-1])         # For largest number
print(a[num-2])         # For 2nd Largest number

'''
#46) To find the second largest number by using " Bubble sort " method:-

a=[]
num=int(input("Enter number of elements:"))             # num=6
for i in range(0,num):                                              # (0,6)
    b=int(input("Enter element:"))
    a.append(b)                                                         # [12,25,365,458,256,487]
for i in range(0,len(a)):                                           # (0,6)
